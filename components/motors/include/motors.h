...
#define MOTOR1_GPIO  4         // M1 for ESP32FC
#define MOTOR2_GPIO  33        // M2 for ESP32FC
#define MOTOR3_GPIO  32        // M3 for ESP32FC
#define MOTOR4_GPIO  25        // M4 for ESP32FC
...
// Test defines
#define MOTORS_TEST_RATIO         (uint16_t)(0.05*(1<<16))
