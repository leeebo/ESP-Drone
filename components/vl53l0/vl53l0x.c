...
bool vl53l0xInitSensor(VL53L0xDev* dev, bool io_2v8)
{
  ...
  if (!vl53l0xPerformSingleRefCalibration(dev, 0x40)) { DEBUG_PRINTD("Failed VHV calibration"); return false; }
  ...
  if (!vl53l0xPerformSingleRefCalibration(dev, 0x00)) { DEBUG_PRINTD("Failed phase calibration"); return false; }
