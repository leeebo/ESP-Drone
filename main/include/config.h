...
//Task stack sizes
#define SYSTEM_TASK_STACKSIZE         (3* configMINIMAL_STACK_SIZE)
#define ADC_TASK_STACKSIZE            configMINIMAL_STACK_SIZE
#define PM_TASK_STACKSIZE             (configMINIMAL_STACK_SIZE)//esp32
...
#define SENSORS_TASK_STACKSIZE        (3* configMINIMAL_STACK_SIZE)
...
#define WIFILINK_TASK_STACKSIZE        (3*configMINIMAL_STACK_SIZE)
#define UDP_TX_TASK_STACKSIZE   (3*configMINIMAL_STACK_SIZE)
#define UDP_RX_TASK_STACKSIZE   (3*configMINIMAL_STACK_SIZE)
#define UDP_RX2_TASK_STACKSIZE   (3*configMINIMAL_STACK_SIZE)
